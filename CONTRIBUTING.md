...
change you wish to make via an [issue] or via
[Slack in the #racial-justice-legit-info 
channel] in the [Call for
Code Slack workspace]. Minor issues can simply
...
(DCO)]. The DCO is a lightweight way for 
...
conventions, and other standards.  See [STYLE.md] for details.
...
reported by contacting the project team on xxxxx . 
